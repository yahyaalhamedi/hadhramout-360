...
export default function LandmarkFormFields({
  form,
  setForm,
  editingId,
  coverFile,
...
}: FormRenderProps<LandmarkFormData>) {
  ...
  return (
    <div className="space-y-5">
        ...
        >
          {coverPreview ? (
            ...
            <>
              ...
              <span className="text-[14px] font-medium">{t('dashboard.landmarks.upload_cover') || 'Upload Cover Image'}</span>
              <span className="text-[12px] text-slate-400">{t('dashboard.landmarks.image_hint') || 'JPG, PNG up to 5MB'}</span>
            </>
          )}
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-[12px] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">{t('dashboard.landmarks.title_ar')}</label>
        ...
        <div>
          <label className="block text-[12px] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">{t('dashboard.landmarks.title_en')}</label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-[12px] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">{t('dashboard.landmarks.desc_ar')}</label>
        ...
        <div>
          <label className="block text-[12px] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">{t('dashboard.landmarks.desc_en')}</label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-[12px] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">{t('dashboard.landmarks.location_ar')}</label>
        ...
        <div>
          <label className="block text-[12px] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">{t('dashboard.landmarks.location_en')}</label>
      ...
      {/* Map URL */}
      <div>
        <label className="block text-[12px] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">{t('dashboard.landmarks.map_url')}</label>
      ...
      {/* Categories */}
      <div>
        <label className="block text-[12px] font-semibold text-slate-500 uppercase tracking-wider mb-1.5">{t('dashboard.landmarks.categories')}</label>
      ...
      <div className="flex flex-col mt-6 mb-2">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[14px] font-semibold text-slate-700">{t('dashboard.landmarks.media_gallery') || 'Media Gallery'}</span>
        ...
        <span className="text-[11px] text-slate-500">{t('dashboard.landmarks.media_hint') || 'Add images or videos'}</span>
      </div>
      ...
      >
        ...
        {isAddingMedia ? t('dashboard.common.uploading') || 'Uploading...' : t('dashboard.landmarks.add_media') || 'Add Media'}
      </button>
    </div>
  )
}
