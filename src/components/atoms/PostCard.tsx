        ...
        <div className="mb-4 flex items-center gap-3 rounded-xl border border-red-200 bg-red-50 p-4">
          <div className="flex-1">
            ...
            <p className="mt-0.5 text-xs text-red-500">
              {t('post.delete_warning', 'This action cannot be undone.')}
            </p>
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={() => setShowDeleteConfirm(false)}
              className="rounded-full border border-red-200 px-3.5 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-100 transition-colors cursor-pointer"
            >
              {t('label.cancel')}
            </button>
            <button
              ...
              disabled={isDeleting}
              className="rounded-full bg-red-600 px-3.5 py-1.5 text-xs font-semibold text-white hover:bg-red-700 disabled:opacity-50 transition-colors cursor-pointer"
            >
              {isDeleting ? t('post.deleting', 'Deleting...') : t('post.delete', 'Delete Post')}
            </button>
          </div>
        </div>
      )}
