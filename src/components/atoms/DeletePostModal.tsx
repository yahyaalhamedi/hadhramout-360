...
export default function DeletePostModal({ open, onClose, onConfirm, isPending }: DeletePostModalProps) {
      ...
      <div className="relative bg-white rounded-[24px] p-8 w-full max-w-[360px] shadow-xl z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-6">
            {t('community.delete_title', 'Are you sure you want to delete?')}
          </h3>
          <button
            onClick={onConfirm}
            disabled={isPending}
          ...
          >
            {isPending ? t('post.deleting', 'Deleting...') : t('post.delete', 'Delete')}
          </button>
          <button
            onClick={onClose}
